...
def app():
    ...
    with top:
        ...
        with colll1:
            ...
            st.title("安装工位：1764斜坡道288号")
            st.title("管道材料：会泽钢管")
            st.subheader("当前状态（在运行） ")
            installDate = date(2022, 11, 10)
            currentDate = date(2022, 8, 17)
    ...
    with col1:
        ...
        current_thickness1 = "13 mm"
        delta_thickness1 = "-2 mm"
        hktimez = pytz.timezone("Asia/Hong_Kong") 
        timenowhk = date(2022, 8, 17)
        ...
        current_thickness2 = "9 mm"
        delta_thickness2 = "-6 mm"
        hktimez = pytz.timezone("Asia/Hong_Kong") 
        timenowhk = date(2022, 8, 17)
        st.markdown("最新状态时间： " + timenowhk.strftime('%Y-%m-%d %H:%M:%S'))
    ...
    with col2:
        ...
        current_thickness3 = "11 mm"
        delta_thickness3 = "-4 mm"
        hktimez = pytz.timezone("Asia/Hong_Kong") 
        timenowhk = date(2022, 8, 17)
        st.markdown("最新状态时间： " + timenowhk.strftime('%Y-%m-%d %H:%M:%S'))
        ...
        current_thickness4 = "11 mm"
        delta_thickness4 = "-4 mm"
        hktimez = pytz.timezone("Asia/Hong_Kong") 
        timenowhk = date(2022, 8, 17)
        st.markdown("最新状态时间： " + timenowhk.strftime('%Y-%m-%d %H:%M:%S'))
