...
def app():
    ...
    with top:
        ...
        with colll1:
            ...
            currentDate = date(2023, 9, 10)
            deltaDays = (currentDate - installDate).days
            st.subheader("已运行时间： " + str(deltaDays) + " Days" + "（已结束）")
        with colll3:
            st.markdown("###")
    ...
    with col1:
        ...
        current_thickness1 = "9 " + " mm"
        delta_thickness1 = "-6 "  + " mm"
        hktimez = pytz.timezone("Asia/Hong_Kong") 
        timenowhk = date(2023, 9, 10)
        ...
        current_thickness2 = "7 mm"
        delta_thickness2 = "-8 mm"
        hktimez = pytz.timezone("Asia/Hong_Kong") 
        timenowhk = date(2023, 9, 10)
        st.markdown("最新状态时间：" + timenowhk.strftime('%Y-%m-%d %H:%M:%S'))
    ...
    with col2:
        ...
        current_thickness3 = "7 mm"
        delta_thickness3 = "-8 mm"
        hktimez = pytz.timezone("Asia/Hong_Kong") 
        timenowhk = date(2023, 9, 10)
        st.markdown("最新状态时间： " + timenowhk.strftime('%Y-%m-%d %H:%M:%S'))
    ...
    with col3:
        # echats
        st.image('page1.png', caption='传感器安装示意图')
    ...
    #    st.image(im3)
    #@st.cache
    iframeLINK = "https://webify-1306024390.cos.ap-shanghai.myqcloud.com/huize.html"
    st.write(
